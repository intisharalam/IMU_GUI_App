...
rep_hold_s      float — seconds angle must stay above rep_enter_deg before
                        the rep is registered as "arm raised". Filters out
                        postural wobbles. Default 0.3s.
...
class ExerciseDef:
    ...
    rep_hold_s:     float = 0.3    # seconds to hold at peak before rep registers
...
EXERCISES: list[ExerciseDef] = [
    ...
    ExerciseDef(
        ...
        description = (
            ...
            "Swing slowly forward — pause briefly at the end of each swing "
            "before returning. Let gravity do the work; do not force the motion. "
            "Best for high-pain days."
        ),
    ...
    ExerciseDef(
        ...
        description = (
            ...
            "Bend the elbow up toward your shoulder — hold for 1 second "
            "at the top — then lower slowly. "
            "Maintains elbow mobility without loading the shoulder."
        ),
    ...
    ExerciseDef(
        ...
        difficulty  = "Easy",
        description = (
            "Stand facing a wall. Walk fingertips upward as far as comfortable "
            "— pause and hold at your highest point for 2 seconds — "
            "then lower slowly. Keep your body upright; do not lean into the wall. "
            "Builds active flexion range gradually."
        ),
    ...
    ExerciseDef(
        ...
        difficulty  = "Moderate",
        description = (
            "Raise the arm forward in the sagittal plane as high as comfortable "
            "— hold at the top for 2 seconds — then lower slowly and with control. "
            "Keep your trunk upright throughout; do not lean back to gain height."
        ),
    ...
    ExerciseDef(
        ...
        difficulty  = "Moderate",
        description = (
            "Raise the arm sideways in the frontal plane as high as comfortable "
            "— hold at the top for 2 seconds — then lower slowly. "
            "Stand tall; do not tilt your body sideways to assist the movement."
        ),
