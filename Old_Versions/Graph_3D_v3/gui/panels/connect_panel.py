...
from PyQt5.QtWidgets import (
    ...
    QPushButton, QFrame, QGridLayout, QSizePolicy, QProgressBar
)
...
class ConnectPanel(QWidget):
    ...
    def _build(self):
        ...
        # I-pose SVG illustration
        self._ipose_svg = QSvgWidget()
        self._ipose_svg.setFixedSize(52, 100)
        self._ipose_svg.setStyleSheet("background:transparent; border:none;")
        self._ipose_svg.load(QByteArray(_svg_ipose().encode("utf-8")))
